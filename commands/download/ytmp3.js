...
module.exports = [
{
    ...
    category: 'download',
    description: 'Download and send YouTube audio (listen in chat)',
    usage: '.ytmp3 <song name or url>',
    execute: async (sock, message, args, context) => {
      ...
      if (!query) {
        return sock.sendMessage(chatId, {
          text: buildHint('Provide a song name', '.ytmp3 <song name>')
        }, { quoted: fake });
      }
      ...
      try {
        ...
        await sock.sendMessage(chatId, {
          audio: audio.buffer || { url: audio.download },
          mimetype: 'audio/mpeg',
          ptt: false,
          ...replyOpts()
        }, { quoted: fake });
