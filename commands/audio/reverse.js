...
{
    name: 'reverse',
    aliases: ['audiorev', 'reverseaudio'],
    category: 'audio',
    description: 'Reverse an audio or video clip',
    usage: '.reverse (reply to audio/video)',
    execute: async (sock, message, args, context) => {
      ...
      if (!media) {
        return sock.sendMessage(chatId, {
          text: buildHint('Reply to audio or video')
        }, { quoted: fake });
      }
      ...
      try {
        ...
        const reversed = await applyAudioEffect(inputBuf, ext, 'areverse');
