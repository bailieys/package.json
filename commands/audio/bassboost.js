...
{
    name: 'bassboost',
    aliases: ['bass', 'bboosted'],
    category: 'audio',
    description: 'Add bass boost effect to audio',
    usage: '.bassboost (reply to audio/video)',
    execute: async (sock, message, args, context) => {
      ...
      try {
        ...
        const boosted = await applyAudioEffect(inputBuf, ext, 'bass=g=15');
